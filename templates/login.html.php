            ...
            <div class="max-w-sm p-10  rounded-xl shadow-[0_0px_15px_black] mx-auto w-full">
                ...
                <form method="POST" action="/login" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent hover:border-orange-500 transition-colors duration-200">
                    ...
                    <?php if (!empty($errors['global'])): ?>
                        <div class="text-red-600 text-sm"><?= htmlspecialchars($errors['global']) ?></div>
                    <?php endif; ?>
                ...
                <div class="mt-6 ml-[30%]  text-center text-sm">
                    <a href="#" class="text-black hover:text-black">Mot de passe oublié?</a>
                    <a href="<?= getenv('BASE_URL') ?>/inscription" class="text-orange-500 hover:text-orange-600">S'inscrire</a>
                </div>
            </div>
        </div>
    </div>
